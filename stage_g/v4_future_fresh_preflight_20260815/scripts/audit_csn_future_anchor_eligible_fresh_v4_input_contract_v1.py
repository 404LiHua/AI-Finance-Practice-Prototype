...
"""Label-free, fail-closed contract audit for V4 pre-registered inputs.
...
def main() -> None:
    ...
    decision = {
        "node_id": "AA_GFMNET_CSN_FUTURE_ANCHOR_ELIGIBLE_FRESH_V4_LABEL_FREE_INPUT_CONTRACT_AUDIT_V1",
